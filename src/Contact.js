  ...
  <div className="w3-padding-32 w3-content w3-text-grey" id="contact">
    ...
    <hr className="w3-opacity" />
      ...
      <div className="w3-section">
        ...
        <p><i className="fa fa-fw w3-xxlarge w3-margin-right"><img src="/img/linkedin-icon.png" className="contact-icon" alt="linedin icon" /></i> LinkedIn: <a href="https://www.linkedin.com/in/jinlin314" target="_blank" rel="noopener noreferrer">linkedin.com/in/jinlin314</a></p>
